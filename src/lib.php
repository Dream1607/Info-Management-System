...
function validate($input, $type = '')
{
    ...
    //single validate
    {
        ...
        $activity_type = array('不限制','体育竞技类','文化艺术类','科技创新类','志愿服务类','知识竞赛类','娱乐放松类','学术讲座类','经验交流类','社会实践类');
        $department = array('不限制','体育部','文化部','外联部','秘书处','实践部','团宣部','团组部','学习部','信息宣','办公室','青年志愿者协会','计算机协会','信息月刊','信息学院辩论队','党总支','研究生会');
